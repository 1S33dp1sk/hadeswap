...
async def deposit_liquidity_to_pair(program_id: PublicKey, connection: Client, pair: PublicKey, authority_adapter: PublicKey, user_pubkey: PublicKey, nft_mint: PublicKey, nft_validation_adapter: PublicKey, proof: list, send_txn):
